...
import com.devoxx.wear.wrapper.SlotsWrapper;
...
public class SlotActivity extends Activity implements WearableListView.ClickListener, GoogleApiClient.ConnectionCallbacks, DataApi.DataListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDataPath = Constants.CHANNEL_ID + Constants.SLOTS_PATH + "/" + mDayMillis;
        ...
        stub.setOnLayoutInflatedListener(new WatchViewStub.OnLayoutInflatedListener() {
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                ...
                mListViewAdapter = new ListViewAdapter(SlotActivity.this, new ArrayList<SlotApiModel>());
    ...
    public void onClick(WearableListView.ViewHolder viewHolder) {
        ...
        SlotApiModel slot = (SlotApiModel) viewHolder.itemView.getTag();
        if (slot == null) {
            return;
        }
    ...
    public void onDataChanged(DataEventBuffer dataEventBuffer) {
        ...
        for (DataEvent event : dataEventBuffer) {
            ...
            if (event.getType() == DataEvent.TYPE_CHANGED && event.getDataItem().getUri().getPath().startsWith(Constants.CHANNEL_ID + Constants.SLOTS_PATH + "/" + mDayMillis)) {

                SlotsWrapper slotsWrapper = new SlotsWrapper();

                final List<SlotApiModel> slotList = slotsWrapper.getSlotsList(event);
                        ...
                        new ResultCallback<DataItemBuffer>() {
                            ...
                            public void onResult(DataItemBuffer dataItems) {
                                ...
                                if (dataItems.getCount() == 0) {
                                    ...
                                    sendMessage(Constants.CHANNEL_ID + Constants.SLOTS_PATH,  mDayMillis.toString());
                                    dataItems.release();
                                    return;
                                }
                                ...
                                final List<SlotApiModel> slotList = slotsWrapper.getSlotsList(dataMap);
    ...
    public class ListViewAdapter extends WearableListView.Adapter {
        private List<SlotApiModel> mDataset;
        private final Context mContext;

        // Provide a suitable constructor (depends on the kind of dataset)
        public ListViewAdapter(Context context, List<SlotApiModel> slotList) {
            mContext = context;
        ...
        public void onBindViewHolder(WearableListView.ViewHolder holder,
            ...
            SlotApiModel slot = mDataset.get(position);

            String slotName = "Unknown talk";

            if (slot.getSlotBreak() != null) {
                slotName = slot.getSlotBreak().getNameEN();
        ...
        public void refresh(List<SlotApiModel> slotList) {
            mDataset = slotList;
